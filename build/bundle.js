...
$iterCreate$1(DictIterator, 'Dict', function(){
  ...
  } while(!has$10(O, key = keys[that._i++]));
...
function reduce(object, mapfn, init){
  ...
  while(length > i)if(has$10(O, key = keys[i++])){
...
function get$1(object, key){
  if(has$10(object, key))return object[key];
}
...
function isDict(it){
  return isObject$23(it) && getPrototypeOf$9(it) === Dict.prototype;
}
...
var get$2      = core_getIteratorMethod;
...
var _objectDefine = function define(target, mixin){
  var keys   = ownKeys$1(toIObject$14(mixin))
    , length = keys.length
    , i = 0, key;
...
$export$120($export$120.S + $export$120.F, 'Object', {define: define$1});
...
$export$121($export$121.S + $export$121.F, 'Object', {
  make: function(proto, mixin){
    return define$2(create$4(proto), mixin);
  }
});
...
var pixiParticles_min = createCommonjsModule(function (module, exports) {
/*!
...
var emitter = new pixiparticles.Emitter(stage, [texture], emitOptions);
exports.lastT = 0;
function animate(t) {
    var dt = t - exports.lastT;
    window.requestAnimationFrame(function (delegateArg0) {
        animate(delegateArg0);
    });
    bunny.rotation = bunny.rotation + 0.1;
    bunny.position.x = Math.sin(t / 1000) * 100 + 250;
    bunny.position.y = -Math.cos(t / 1000) * 100 + 250;
...
exports.pixiparticles = pixiparticles;
...
exports.bunny = bunny;
exports.emitOptions = emitOptions;
